#
# pytest1 documentation build configuration file
#
import os
import sys
...
project = "pytest1"
copyright = "Copyright © 2026 Nour Shawky"
...
# built documents.
try:
    version = importlib.metadata.version("pytest1")
